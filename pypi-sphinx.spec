...
Source0  : https://files.pythonhosted.org/packages/5b/be/50e50cb4f2eff47df05673d361095cafd95521d2a22521b920c67a372dcb/sphinx-7.4.7.tar.gz
...
%prep
%setup -q -n sphinx-7.4.7
cd %{_builddir}/sphinx-7.4.7
pushd ..
cp -a sphinx-7.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722280071
