...
Source0  : https://files.pythonhosted.org/packages/81/46/08fe30fc7a6b0e8ff1f502e44133d3a1bd9453d7ab884c2ac7f0ef280920/sphinx-8.2.0.tar.gz
...
%prep
%setup -q -n sphinx-8.2.0
cd %{_builddir}/sphinx-8.2.0
pushd ..
cp -a sphinx-8.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739986885
