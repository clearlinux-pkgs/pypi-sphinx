...
Source0  : https://files.pythonhosted.org/packages/38/ad/4360e50ed56cb483667b8e6dadf2d3fda62359593faabbe749a27c4eaca6/sphinx-8.2.3.tar.gz
...
Requires: pypi(requests)
Requires: pypi(roman_numerals_py)
Requires: pypi(snowballstemmer)
...
%prep
%setup -q -n sphinx-8.2.3
cd %{_builddir}/sphinx-8.2.3
pushd ..
cp -a sphinx-8.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741036579
