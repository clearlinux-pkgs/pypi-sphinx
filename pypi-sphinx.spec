...
Source0  : https://files.pythonhosted.org/packages/b6/3e/cb066e5cb76302f73a20e302b40e6fd5aea9462ce520581165348c008913/Sphinx-5.1.0.tar.gz
...
%prep
%setup -q -n Sphinx-5.1.0
cd %{_builddir}/Sphinx-5.1.0
pushd ..
cp -a Sphinx-5.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658765016
