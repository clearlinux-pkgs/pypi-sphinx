...
Source0  : https://files.pythonhosted.org/packages/c6/81/8ef210d47c9df9c184c5c1b832e92b50eea11e2463ed7254a3661c0b3e83/sphinx-7.4.6.tar.gz
...
%prep
%setup -q -n sphinx-7.4.6
cd %{_builddir}/sphinx-7.4.6
pushd ..
cp -a sphinx-7.4.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721318785
